...
**CGPA:** 8.42/10.0  
- Peer Tutor (Data Structures & Algorithms, Discrete Mathematics, Automata Theory)  
- Passionate about Generative AI, Retrieval-Augmented Generation (RAG), and AI Automation  
...
An AI-powered study assistant that enables users to upload PDF notes and receive accurate, context-aware answers using Retrieval-Augmented Generation (RAG).
- Designed a scalable RAG pipeline with PDF parsing, semantic chunking, vector embeddings, and MongoDB Atlas Vector Search.
...
### 🛠️ Deskline -AI Helpdesk And Wokflow Automation System
